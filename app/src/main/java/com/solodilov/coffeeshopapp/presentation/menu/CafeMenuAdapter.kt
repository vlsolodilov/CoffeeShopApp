...
class CafeMenuAdapter(
...
) : ListAdapter<Coffee, CoffeeViewHolder>(CoffeeDiffCallback()) {
    ...
    override fun onBindViewHolder(holder: CoffeeViewHolder, position: Int, payloads: List<Any>) {
...
class CoffeeViewHolder(
    ...
    fun bind(coffee: Coffee) {
        binding.menuItemName.text = coffee.name
        binding.menuItemPrice.text = itemView.context.getString(R.string.coffee_price, coffee.price)
